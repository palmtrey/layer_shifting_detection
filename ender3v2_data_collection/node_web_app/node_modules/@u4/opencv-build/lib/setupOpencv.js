...
class SetupOpencv {
    ...
    async getMsbuildIfWin() {
        if (this.builder.env.isWin) {
            const msbuild = await (0, findMsBuild_js_1.findMsBuild)();
            npmlog_1.default.info('install', `using msbuild: ${(0, utils_js_1.formatNumber)("%s")} path: ${(0, utils_js_1.highlight)("%s")}`, msbuild.version, msbuild.path);
            return msbuild;
        }
        return undefined;
    }
